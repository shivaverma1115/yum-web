        ...
        <div>
            <div className="w-full lg:ps-64">
                <div className="p-6 page-content">
                    ...
                    {/* {{> admin - page - title subtitle="Products" title="Products Edit"}} */}
                    ...
                    <div className="grid lg:grid-cols-3 gap-6">
                        <div className="p-6 rounded-lg border border-default-200">
                            <div className="h-96 p-6 flex flex-col items-center justify-center rounded-lg border border-default-200 mb-4">
                                ...
                                <img src="/images/dishes/burrito-bowl.png" alt="" />
                            </div>
                            ...
                            <div className="p-6 rounded-lg border border-default-200">
                                <div className="grid lg:grid-cols-2 gap-6 mb-6">
                                    <div className="space-y-6">
                                        <div>
                                            <input className="block w-full bg-transparent rounded-lg py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="text" placeholder="Product Name" defaultValue="Burrito Bowl" />
                                        </div>

                                        <div>
                                            <select defaultValue="italian" className="block w-full bg-transparent rounded-lg py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50">
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-6">
                                            <div>
                                                <input className="block w-full bg-transparent rounded-lg py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="text" placeholder="Selling Price" defaultValue="$45" />
                                            </div>

                                            <div>
                                                <input className="block w-full bg-transparent rounded-lg py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="text" placeholder="Cost Price" defaultValue="$35" />
                                            </div>
                                        </div>

                                        <div>
                                            <input className="block w-full bg-transparent rounded-lg py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="number" placeholder="Quantity in Stock" defaultValue="80" />
                                        </div>
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            <textarea className="block w-full bg-transparent rounded-lg py-2.5 px-4 border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" rows={5} placeholder="Short Description" defaultValue="Mexican burritos are usually made with a wheat tortilla and contain grilled meat, cheese toppings, and fresh vegetables which are sources of vitamins, proteins, fibers, minerals, and antioxidants." />
                                        </div>
