                    ...
                    <div className="flex justify-center items-center lg:max-w-lg">
                        <div className="flex flex-col h-full">
                            <div className="shrink">
                                ...
                                <div className="">
                                    <h1 className="text-3xl font-semibold text-default-800 mb-2">Forgot Password</h1>
                                ...
                                <div className="pt-16">
                                    <div className="mb-6">
                                        <label className="block text-sm font-medium text-default-900 mb-3" htmlFor="LoggingEmailAddress">Email</label>
                                        <input id="LoggingEmailAddress" className="block w-full rounded-full py-2.5 px-4 bg-white border border-default-200 focus:ring-transparent focus:border-default-200 dark:bg-default-50" type="email" placeholder="Enter your email" />
                                    </div>

                                    <div className="flex flex-col justify-center gap-4 mb-6">
                                        <a href="reset-password" className="relative inline-flex items-center justify-center px-6 py-3 rounded-full text-base bg-primary text-white capitalize transition-all hover:bg-primary-500 w-full">Reset Password</a>
                                        <a href="login" className="relative inline-flex items-center justify-center px-6 py-3 rounded-full text-base border border-primary text-primary capitalize transition-all hover:bg-primary hover:text-white w-full">Go to Login</a>
                                    </div>
                            ...
                            <div className="grow flex items-end justify-center mt-16">
                                <p className="text-default-500 text-center mt-auto">Back to<a href="login" className="text-primary ms-1"><span className="font-medium">Login</span></a></p>
                            </div>
                        </div>
                    </div>
                </div>
