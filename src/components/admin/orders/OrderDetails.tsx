          ...
          <div>
            <div className="rounded-lg border border-default-200">
              ...
              <div className="p-6 text-center">
                ...
                />
                <h4 className="text-base font-medium text-default-800 mb-2">
                  Jay Logistics
                </h4>
                <p className="text-base font-medium text-default-700 mb-2">
                  ID: JLST2023477890
                </p>
          ...
          <div className="relative my-10">
            <div className="md:flex hidden mx-20 -mb-6">
              <div className="flex w-full h-1.5 bg-default-200 rounded-full overflow-hidden">
                <div className="w-1/2 flex flex-col justify-center overflow-hidden bg-primary rounded-full" />
              </div>
            </div>
            ...
            <div className="absolute inset-y-0 start-1/2 -translate-x-1/2 md:hidden flex">
              <div className="absolute inset-y-0 start-1/2 -translate-x-1/2 flex h-full w-1.5 bg-default-200 rounded-full overflow-hidden">
                <div className="absolute top-0 bottom-1/2 start-1/2 -translate-x-1/2 w-1.5 flex flex-col justify-center overflow-hidden bg-primary rounded-full" />
              </div>
            </div>
            ...
            <div className="flex md:flex-row flex-col justify-between items-center gap-8 relative z-10 mx-10">
              <div className="flex flex-col justify-center items-center">
                ...
                <h4 className="text-sm text-default-800 mt-3 p-2 md:bg-transparent bg-default-100 md:shadow-none shadow rounded-lg">
                  Order received
                </h4>
              </div>
                  ...
                  <table className="min-w-full divide-y divide-default-200">
                    <thead className="bg-default-400/10">
                      <tr>
                        ...
                        <th
                          scope="col"
                          className="px-5 py-3 text-start text-xs font-medium text-default-500 whitespace-nowrap uppercase"
                        >
                          Price
                        </th>
                        <th
                        ...
                        <th
                          scope="col"
                          className="px-5 py-3 text-center text-xs font-medium text-default-500 whitespace-nowrap uppercase"
                        >
                          Sub-Total
                        </th>
                      </tr>
                    ...
                    <tbody className="divide-y divide-default-200">
                      <tr>
                        <td className="px-5 py-3 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            <img
                              src="/images/dishes/onion-rings.png"
                              alt=""
                              className="h-18 w-18"
                            />
                            <h4 className="text-sm font-medium text-default-800">
                      ...
                      <tr>
                        <td className="px-5 py-3 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            <img
                              src="/images/dishes/burrito-bowl.png"
                              alt=""
                              className="h-18 w-18"
                            />
                            <h4 className="text-sm font-medium text-default-800">
                      ...
                      <tr>
                        <td className="px-5 py-3 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            <img
                              src="/images/dishes/garlic-herb-bread.png"
                              alt=""
                              className="h-18 w-18"
                            />
                            <h4 className="text-sm font-medium text-default-800">
        ...
        <div className="xl:col-span-1 md:col-span-2">
          <div className="rounded-lg border border-default-200">
            ...
            <div className="px-4">
              ...
              <div className="py-4 flex justify-between border-b border-default-200">
                <h4 className="text-sm text-default-700">
                  Card Holder Name :
                </h4>
                <h4 className="text-sm font-medium text-default-800">
                  Jaylon Calzoni
