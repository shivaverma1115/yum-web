...
export default function SellerDetails({ sellerId }: SellerDetailsProps) {
    return (
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-6">
            <div className="lg:col-span-1">
                <div className="p-6 rounded-lg border border-default-200">
                    <img src="/images/avatars/avatar4.png" alt="" className="w-24 rounded-full p-1 border border-gray-200 bg-gray-100 dark:bg-gray-700 dark:border-gray-600" />
                    ...
                    <div className="text-start mt-6">
                        ...
                        <p className="text-zinc-400 mb-3"><strong>Full Name :</strong> <span className="ms-2">Kaiya Botosh</span></p>

                        <p className="text-zinc-400 mb-3"><strong>Mobile :</strong><span className="ms-2">(123) 123 1234</span></p>

                        <p className="text-zinc-400 mb-3"><strong>Email :</strong> <span className="ms-2 ">user@email.domain</span></p>

                        <p className="text-zinc-400 mb-1.5"><strong>Location :</strong> <span className="ms-2">USA</span></p>
                    </div>
                </div>
            </div>
                ...
                <div className="border rounded-lg border-default-200">
                    <div className="px-6 py-4">
                        <div className="flex flex-wrap justify-between items-center gap-6">
                            <h4 className="text-xl font-medium text-default-900">Selles Order history</h4>
